...
const allowed = ["telegramToken", "telegramChatId", "smtpHost", "smtpPort", "smtpUser", "smtpPassword", "emailFrom", "emailTo", "blockingSeverities", "postReviewComment", "githubAssigneeMappings"];
